...
l+=[RL(algo_type=0,size=100,resource_limit=4,xp_rate=0.15,xp_decay=0.8,ucb_sigma=2,gradient_learning_rate=0.03,baseline=1,num_split_and_dump=10
,initial_reward=2)]
...
#%%
Game.run(num_thousand_rounds=20000)
A=Game.analysis()
